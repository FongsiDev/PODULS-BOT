      ...
      try {
        ...
        if(channel && channel.permissionsFor(channel.guild.me).has(Permissions.FLAGS.SEND_MESSAGES)){
          ...
          collector.on('collect', async i => {
              ...
              if (!player)
                return i?.reply({content: "<:Error:954528313517428757> Nothing Playing yet", ephemeral: true})
...
/**
* @INFO
* Bot Coded by Fongsi#1557 | https://github?.com/Tomato6966/discord-js-lavalink-Music-Bot-erela-js
* @INFO
