      ...
      if(user) {
        ...
        message.reply({ 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by PODULS BOT DDNS`, "https://media.discordapp.net/attachments/959868825581543458/965216739380056084/emoji.png"))],
