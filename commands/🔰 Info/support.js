...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    ...
    try {
      let button_support_dc = new MessageButton().setStyle('LINK').setLabel('Support Server').setURL("https://discord.com/gg/ywojoap")
      ...
      message.reply({
        embeds: [new MessageEmbed()
          ...
          .setFooter('PODULS BOT | powered by PODULS BOT DDNS', 'https://imgur.com/jPItIw0.gif')
          .setURL("https://discord.com/oauth2/authorize?client_id=965191378059550750&permissions=8&scope=applications.commands%20bot")],
